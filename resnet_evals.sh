#!/bin/bash
#SBATCH --array=6,11,16,21,2,7,12,17,22
...
#SBATCH --exclude=freddie,havoc,r4,r16,atlas,blaze,flaminio,steropes,manchester,como,luigi,bombe
##SBATCH --nodelist=freddie
#SBATCH -n 1 # number of tasks (i.e. processes)
#SBATCH --cpus-per-task=1 # number of cores per task
#SBATCH --gres=gpu:1
#SBATCH -t 7-00:00 # time requested (D-HH:MM)
#SBATCH -o resnet_evals_wrong_reverse_%A_%a.out
...
SAVE=/data/eliciaye/val_experiments/me-prune/cifar100/resnet$depth-$idx-$init_lr-evals
...
python resnet_evals.py --checkpoint $SAVE --lr $init_lr --Net $Net --seed $seed
echo "All done."
