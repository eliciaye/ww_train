...
#SBATCH --array=1,6,11,16,21,2,7,12,17,22
##SBATCH --array=1,6,11,16,21,2,7,12,17,22,73-84
...
#SBATCH -o resnet_rewindlr_%A_%a.out
...
SAVE=/data/eliciaye/val_experiments/me-prune/cifar100/resnet$depth-$idx-rewindlr$init_lr
...
cd ../trainer
python resnet_lr_rewind.py --checkpoint $SAVE --lr $init_lr --Net $Net --seed $seed
echo "All done."
