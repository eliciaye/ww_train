...
#SBATCH --exclude=freddie,havoc,r4,r16,atlas,blaze,flaminio,manchester,steropes,bombe,pavia,como,luigi,zanino
##SBATCH --nodelist=pavia
#SBATCH -n 1 # number of tasks (i.e. processes)
#SBATCH --cpus-per-task=1 # number of cores per task
#SBATCH --gres=gpu:1
#SBATCH -t 7-00:00 # time requested (D-HH:MM)
#SBATCH -o resnet_thiswork_%A_%a.out
...
python resnet_width.py --checkpoint $SAVE --lr $init_lr --Net $Net --epochs $epochs --seed $seed
echo "All done."
